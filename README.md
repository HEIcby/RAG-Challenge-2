...
| 环境 | 状态 | 地址 | 更新时间 |
|------|------|------|----------|
| **生产服务器** | 🟢 运行中 | http://10.222.4.30:8501 | 2025-11-10 |
| **本地开发** | ✅ 可用 | http://localhost:8501 | - |

**生产环境配置**:
- 服务器: Debian 6.12.48 (jinpan-rag-demo)
- Python: 3.13.5
- 资源: 8GB RAM, 20GB+ 磁盘
- 数据集: val_set (5GB, 包含向量数据库)
- 详细部署记录: [docs/DEPLOYMENT_10.222.4.30.md](docs/DEPLOYMENT_10.222.4.30.md)
